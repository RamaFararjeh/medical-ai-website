        ...
        <tbody>
          @forelse($items as $row)
            <tr>
              ...
              <td>
                <a href="{{ route('admin.work.edit',$row) }}" class="btn btn-sm btn-outline-primary">
                  <i class="fa-regular fa-pen-to-square me-1"></i> Edit
                </a>
                <form class="d-inline" method="POST" action="{{ route('admin.work.destroy',$row) }}"

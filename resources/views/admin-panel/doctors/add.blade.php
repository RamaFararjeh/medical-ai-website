      ...
      <form method="POST" action="{{ route('admin.doctors.store') }}" enctype="multipart/form-data">
        ...
        <div class="row g-3">
          ...
          <div class="col-md-3">
            ...
            <input type="number" name="age" value="{{ old('age') }}" class="form-control" min="0" max="120">
          </div>
          <div class="col-md-3">
          ...
          <div class="col-md-3">
            ...
            <input type="number" name="years_experience" value="{{ old('years_experience') }}" class="form-control" min="0" max="80">
          </div>
          <div class="col-md-3">
          ...
          <div class="col-md-6">
            ...
            <input type="text" name="phone" value="{{ old('phone') }}" class="form-control" placeholder="+962 7X XXX XXXX">
          </div>
